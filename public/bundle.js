...
/* harmony import */ var _app_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(25);
...
/* harmony import */ var _babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(13);
/* harmony import */ var _babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(15);
/* harmony import */ var _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_8__);
/* harmony import */ var _component_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(17);
/* harmony import */ var _components_PhonesCatalog_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(20);
/* harmony import */ var _components_PhoneViewer_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(21);
/* harmony import */ var _components_ShoppingCart_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(22);
/* harmony import */ var _components_Filter_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(23);
/* harmony import */ var _PhonesService_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(24);
...
function (_Component) {
  ...
  function PhonesPage(element, props) {
    ...
    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_3___default()(this, PhonesPage);

    _this = _babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_5___default()(this, _babel_runtime_helpers_getPrototypeOf__WEBPACK_IMPORTED_MODULE_6___default()(PhonesPage).call(this, element, props));
    _this._state = {
      isLoaded: false,
      phones: [],
      selectedPhone: null,
    ...
    _this.setSelectedPhone = _this.setSelectedPhone.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_7___default()(_this));
    _this.clearSelectedPhone = _this.clearSelectedPhone.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_7___default()(_this));
    _this.addItem = _this.addItem.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_7___default()(_this));
    _this.removeItem = _this.removeItem.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_7___default()(_this));
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_4___default()(PhonesPage, [{
    key: "_loadPhones",
    value: function () {
      var _loadPhones2 = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_2___default()(
      /*#__PURE__*/
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return _PhonesService_js__WEBPACK_IMPORTED_MODULE_14__["default"].getAll().catch(function () {
                  return [];
                });
      ...
      function _loadPhones() {
        return _loadPhones2.apply(this, arguments);
      }
    ...
    value: function _render() {
      this._element.innerHTML = "\n      <div class=\"row\">\n\n        <!--Sidebar-->\n        <div class=\"col-md-2\">\n          <section>\n            <div data-component=\"Filter\"></div>\n          </section>\n  \n          <section>\n            <div data-component=\"ShoppingCart\"></div>\n          </section>\n        </div>\n  \n        <!--Main content-->\n        <div class=\"col-md-10\">\n          ".concat(this._state.selectedPhone ? "\n            <div data-component=\"PhoneViewer\"></div>\n          " : "\n            ".concat(this._state.isLoaded ? "\n              <div data-component=\"PhonesCatalog\"></div>\n            " : "\n              <p>Loading ...</p>\n            ", "\n          "), "\n        </div>\n      </div>\n    ");

      this._initComponent(_components_PhonesCatalog_js__WEBPACK_IMPORTED_MODULE_10__["default"], {
        phones: this._state.phones,
        onPhoneSelected: this.setSelectedPhone,
        onAdd: this.addItem
      });

      this._initComponent(_components_PhoneViewer_js__WEBPACK_IMPORTED_MODULE_11__["default"], {
        phone: this._state.selectedPhone,
        onBack: this.clearSelectedPhone,
        onAdd: this.addItem
      });

      this._initComponent(_components_ShoppingCart_js__WEBPACK_IMPORTED_MODULE_12__["default"], {
        items: this._state.items,
        onRemove: this.removeItem
      });

      this._initComponent(_components_Filter_js__WEBPACK_IMPORTED_MODULE_13__["default"]);
    }
  }, {
    key: "setSelectedPhone",
    value: function () {
      var _setSelectedPhone = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_2___default()(
      /*#__PURE__*/
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.mark(function _callee2(phoneId) {
        var phoneDetails;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return _PhonesService_js__WEBPACK_IMPORTED_MODULE_14__["default"].getById(phoneId);
      ...
      function setSelectedPhone(_x) {
        return _setSelectedPhone.apply(this, arguments);
      }

      return setSelectedPhone;
    }()
  }, {
    key: "clearSelectedPhone",
    value: function clearSelectedPhone() {
      this._setState({
        selectedPhone: null
      });
    }
    ...
    value: function addItem(phoneId) {
      this._setState({
        items: [].concat(_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(this._state.items), [phoneId])
      });
    }
  }, {
    key: "removeItem",
    value: function removeItem(itemToRemove) {
      this._setState({
        items: this._state.items.filter(function (item) {
...
/* harmony import */ var _babel_runtime_helpers_objectSpread__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(18);
...
function () {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2___default()(Component, [{
    key: "_initComponent",
    value: function _initComponent(componentConstructor) {
      var props = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      var name = componentConstructor.name;

      var element = this._element.querySelector("[data-component=\"".concat(name, "\"]"));

      var currentInstance = this._components[name];
    ...
    key: "setProps",
    value: function setProps(partial) {
      this._props = _babel_runtime_helpers_objectSpread__WEBPACK_IMPORTED_MODULE_0___default()({}, this._props, partial);

      this._render();
    }
  }, {
    key: "_setState",
    value: function _setState(partial) {
      this._state = _babel_runtime_helpers_objectSpread__WEBPACK_IMPORTED_MODULE_0___default()({}, this._state, partial);
...
function (_Component) {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(PhonesCatalog, [{
    ...
    value: function _initEventListeners() {
      ...
      this.on('click', 'details-link', function (_ref) {
        var detailsLink = _ref.delegateTarget;

        _this2._props.onPhoneSelected(detailsLink.dataset.phoneId);
      });
      this.on('click', 'add-button', function (_ref2) {
        var addButton = _ref2.delegateTarget;

        _this2._props.onAdd(addButton.dataset.phoneId);
      });
    }
  }, {
    key: "_render",
    value: function _render() {
      this._element.innerHTML = "\n      <ul class=\"phones\">\n        ".concat(this._props.phones.map(function (phone) {
...
function (_Component) {
  ...
  function PhoneViewer(element, props) {
    ...
    _this.on('click', 'back-button', _this._props.onBack);

    _this.on('click', 'add-button', function () {
      return _this._props.onAdd(_this._props.phone.id);
    });

    _this.on('click', 'small-image', function (_ref) {
      var image = _ref.delegateTarget;
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(PhoneViewer, [{
    key: "_render",
    value: function _render() {
      var phone = this._props.phone;
      var currentImage = this._state.currentImage;
...
function (_Component) {
  ...
  function ShoppingCart(element, props) {
    ...
    _this.on('click', 'remove-button', function (_ref) {
      var removeButton = _ref.delegateTarget;

      _this._props.onRemove(removeButton.dataset.item);
    });
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(ShoppingCart, [{
    key: "_render",
    value: function _render() {
      this._element.innerHTML = "\n      <div>\n        <p>Shopping Cart</p>\n        <ul>\n          ".concat(this._props.items.map(function (item) {
...
function (_Component) {
  ...
  function Filter(element, props) {
    ...
    _this.on('change', 'query', function (_ref) {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(Filter, [{
    key: "_render",
    value: function _render() {
      this._element.innerHTML = "\n      <div>\n        <p>\n          Search:\n          <input\n            data-element=\"query\"\n            value=\"".concat(this._state.value, "\"\n          >\n        </p>\n\n        <p>\n          Sort by:\n          <select>\n            <option value=\"name\">Alphabetical</option>\n            <option value=\"age\">Newest</option>\n          </select>\n        </p>\n      </div>\n    ");
    }
  }]);
...
/* harmony import */ var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8);
/* harmony import */ var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__);


var API_URL = 'https://mgrinko.github.io/js-20190122/api'; // const API_URL = 'http://127.0.0.1:8080/api';
